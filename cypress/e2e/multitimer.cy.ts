...
describe('Tests Multi-Timer', () => {
  ...
  it('12s timer', () => {
    ...
    cy.should(() => {
      ...
      expect(firstEnd.getTime()).to.be.lt(Date.now() + 12 * 1000)
    })
  })
  ...
  it('1.2min timer 1', () => {
    ...
    cy.should(() => {
      ...
      expect(firstEnd.getTime()).to.be.lt(Date.now() + 1.2 * 60 * 1000)
      expect(firstEnd.getTime()).to.be.gt(Date.now() + 1.2 * 60 * 1000 - 1000)
    })
  })
  ...
  it('1.2h timer', () => {
    ...
    cy.should(() => {
      ...
      expect(firstEnd.getTime()).to.be.lt(Date.now() + 1.2 * 3600 * 1000)
      expect(firstEnd.getTime()).to.be.gt(Date.now() + 1.2 * 3600 * 1000 - 1000)
    })
  })
  ...
  it('1.2d timer', () => {
    ...
    cy.should(() => {
      ...
      expect(firstEnd.getTime()).to.be.lt(Date.now() + 1.2 * 24 * 3600 * 1000)
      expect(firstEnd.getTime()).to.be.gt(Date.now() + 1.2 * 24 * 3600 * 1000 - 1000)
    })
  })
  ...
  it('add and delete 1 timer', () => {
    ...
    cy.should(() => {
      ...
      expect(firstEnd.getTime()).to.be.lt(Date.now() + 1.1 * 3600 * 1000)
      expect(firstEnd.getTime()).to.be.gt(Date.now() + 1.1 * 3600 * 1000 - 1000)
    })
    // delete 1 timer
